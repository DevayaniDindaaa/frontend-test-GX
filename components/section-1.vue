...
<template>
    <div class="flex flex-col lg:grid grid-cols-2 gap-10 items-center justify-center text-center">
        <div class="flex flex-col gap-5 lg:text-left text-center">
        ...
        <div class="flex flex-col gap-[30px] lg:text-left text-center justify-self-end lg:mt-0 mt-5 z-50">
            <img class="flex rounded-lg h-fit w-full" src="/img/img-section-1.webp" alt="img-3" />
        </div>
    </div>
</template>